...
class REPORTCANVA2(COLOR):
    ...
    def create_pdf(self):
        ...
        #frame page 1
        frame_page_0 = [frame_big_logo]
        page_0 = PageTemplate(id = 'page_0',frames = frame_page_0,pagesize=A4, )
        doc = BaseDocTemplate(self.buffer, pagesize=landscape(A4), pageTemplates =[page_0],
        ...
        story.append(Paragraph('Hello World !',style = style_para))
        doc.build(story)
        return self.buffer


class REPORTCANVA(COLOR):
    def __init__(self):
        super().__init__()
